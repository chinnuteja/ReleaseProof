...
export default function HomePage() {
  ...
  return <main>
    ...
    <section className="proof-story" aria-labelledby="proof-story-title"><div className="story-intro"><p className="eyebrow">The proof under pressure</p><h2 id="proof-story-title">When the system changes its mind, the authority does not.</h2><p>This is the ReleaseProof demo: a human approves revision A. The branch moves to B, an API response disappears, and the agent still proves exactly what happened.</p></div><div className="story-flow"><div className="story-step"><span>01</span><b>Linear selects <code>A</code></b><small>One requested release candidate.</small></div><i>→</i><div className="story-step gold"><span>02</span><b>Slack approves <code>A</code></b><small>The authority freezes SHA and intent.</small></div><i>→</i><div className="story-step warning"><span>03</span><b>Branch advances to <code>B</code></b><small>ReleaseProof refuses the drift.</small></div><i>→</i><div className="story-step"><span>04</span><b>GitHub reply disappears</b><small>No blind retry. Read back the marker.</small></div><i>→</i><div className="story-step success"><span>05</span><b>Receipt proves <code>A</code></b><small>GitHub, Linear, and Slack agree.</small></div></div></section>
